...
import id.lombokit.emarkethamzanwadi.Adapters.CartPageAdapter;
...
public class Shopping_cart extends AppCompatActivity {
    private CartPageAdapter cartPageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideUpAnimation= AnimationUtils.loadAnimation(this, R.anim.slide_up_linear);
        ...
        RecyclerView.LayoutManager mLayoutManagerHappyHours = new LinearLayoutManager(this,
        ...
        timingsAdapter = new TimingsAdapter(this, stringArrayList);
        ...
        frameOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent it = new Intent(Shopping_cart.this, MainActivity.class);
                startActivity(it);
            }
        });
        ...
        customTab.addTab(customTab.newTab().setText("CART"));
        ...
        cartPageAdapter = new CartPageAdapter
                (getSupportFragmentManager(), customTab.getTabCount());
        pager.setAdapter(cartPageAdapter);
